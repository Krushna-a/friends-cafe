      ...
      <div className="h-screen bg-soft-cream p-4 mt-2 flex items-center justify-center">
        <div className="bg-clean-white rounded-2xl shadow-lg border border-beige p-12">
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-dark-cocoa mb-2">
              No statistics available
            </h3>
            <p className="text-muted-brown">
              Statistics will appear once you have order data
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-clean-white rounded-2xl shadow-lg p-6 border border-beige">
            <div className="flex items-center justify-between mb-3">
              <div className="text-sm font-semibold text-muted-brown">
                Total Revenue
              </div>
          ...
          <div className="bg-clean-white rounded-2xl shadow-lg p-6 border border-beige">
            ...
            <div className="text-xs text-muted-brown mt-1">(30% margin)</div>
          </div>
          ...
          <div className="bg-clean-white rounded-2xl shadow-lg p-6 border border-beige">
            ...
            <div className="text-xs text-muted-brown mt-1">
              {stats.summary.paidOrders} paid, {stats.summary.pendingOrders}{" "}
              pending
            </div>
          </div>
          ...
          <div className="bg-clean-white rounded-2xl shadow-lg p-6 border border-beige">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="w-10 h-10 bg-coffee-brown/10 rounded-full flex items-center justify-center">
                <svg
                  className="w-5 h-5 text-coffee-brown"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                >
                  {Object.entries(stats.ordersByStatus).map((entry, index) => (
                    <Cell
                      key={`cell-${index}`}
                      fill={
                        ["#7A3E1D", "#C66A2B", "#4B2A1A", "#6B4F3F", "#2B1B12"][
                          index % 5
                        ]
                      }
                    />
              ...
              <tbody className="divide-y divide-beige">
                {stats.topSellingItems.length > 0 ? (
                  stats.topSellingItems.map((item, index) => (
                    ...
                    >
                      <td className="px-4 py-3 text-sm font-medium text-dark-espresso">
                        {item.name}
                      </td>
                  ...
                  <tr>
                    <td colSpan="3" className="px-4 py-8 text-center">
                      <div className="text-muted-brown">
                        No items sold in this period
                      </div>
                    </td>
                  </tr>
