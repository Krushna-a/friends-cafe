                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4">
                      <div className="bg-soft-cream/50 rounded-xl p-3">
                        <div className="text-xs text-muted-brown mb-1">
                          User ID
                        </div>
                        <div className="text-sm font-mono text-dark-espresso">
                          {user._id}
                        </div>
                      </div>
                      <div className="bg-soft-cream/50 rounded-xl p-3">
                        ...
                        <div className="text-lg font-bold text-coffee-brown">
                          {user.orderCount || 0}
                        </div>
                      </div>
                    </div>
                    ...
                    {user.orders && user.orders.length > 0 && (
                      ...
                      >
                        <svg
                          className={`w-4 h-4 transition-transform ${expandedUser === user._id ? "rotate-90" : ""}`}
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
