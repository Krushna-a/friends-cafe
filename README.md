...
A complete restaurant management system with customer ordering, staff management, and WhatsApp notifications.
...
The system uses Twilio WhatsApp Business API for:
- Order confirmations
- Payment receipts
- Order status updates
- Customer support

See [TWILIO_WHATSAPP_PRODUCTION_SETUP.md](TWILIO_WHATSAPP_PRODUCTION_SETUP.md) for setup instructions.
