...
const Footer = () => {
  ...
  const HomeIcon = ({ isActive }) => (
    <svg
      className={`w-6 h-6 transition-colors duration-300 ${
        isActive ? "text-[#6F4E37]" : "text-[#8B7355]"
      }`}
      fill="none"
      stroke="currentColor"
      strokeWidth="2"
  ...
  return (
    <>
      ...
      <div className="bg-[#EFE6D8] border-t border-[#D4C4B0] py-2 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 text-sm">
            <Link
              to="/contact"
              className="text-[#6F4E37] hover:text-[#5A3E2B] transition-colors duration-200"
            >
              Contact Us
            </Link>
            <Link
          ...
          <div className="mt-4 pt-4 border-t border-[#D4C4B0] text-center text-xs text-[#8B7355]">
            <p>
              ...
              {({ isActive }) => (
                <>
                  <div
                    ...
                    ${
                      isActive
                        ? "bg-[#6F4E37]/20 shadow-lg shadow-[#6F4E37]/20"
                        : "hover:bg-white/10"
                    }
                  `}
                  >
